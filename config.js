...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/y9rn5dl.jpeg Hey {sender},ꪀ𝓳ꪖꪀ ꫀꪜ𝓲ᦔꫀ ꪮꪀᦔꪖ𝓲 ✨️\n Uptime: {uptime}",
    ...
    ANTISPAM_COUNT: process.env.ANTISPAM_COUNT || '7/10',https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Munna Mwol;Kiran Ser;0;https://i.imgur.com/y9rn5dl.jpeg;https://chat.whatsapp.com/H7IlnOYuh0TBqAe19NDov0',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA||"Munna Mwol",
    BOT_NAME: process.env.BOT_NAME || 'Munna Mwol',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'кιяαи ѕєя;ꪑꪊꪀꪀꪖ ꪑ᭙ꪮꪶ;https://i.imgur.com/y9rn5dl.jpeg' : process.env.AUDIO_DATA,
